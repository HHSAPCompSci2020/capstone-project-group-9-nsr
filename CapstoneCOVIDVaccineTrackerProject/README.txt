...
* Something that allows us to read data live from a website[c]
   * The information should be updated consistently and frequently from the website.
* Facts about the vaccines[d]
...
* Information for individual states 
   ...
   * Each state will include facts and statistics on the state.[e]
...
StatisticsAndGraphs- the graph and statistics page
...
[a]keep updating
[b]It might be a little on the less on the original side cause there is most likely many types of website and programs that provides covid related statistics
[c]Many apis you could look to get the data most likely
[d]Its a lot of information and statistics, one of the things that might be an issue is that not one api or website will hold all the information meaning you would have to gather multiple sources to get the information which might become slightly annoying
[e]State and country statistics can be combined into just one statistics feature. They are basically the same feature.